      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-amber-900 mb-4">Contato e Localização</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-amber-900 mb-2">Endereço</h3>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-amber-900 mb-2">Telefone</h3>
                    <a 
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-amber-900 mb-2">Horário de Funcionamento</h3>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold text-amber-900 mb-4">Informações da Clínica</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md">
              <h3 className="text-2xl font-semibold text-amber-900 mb-6">Agende sua Consulta</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="text-center">
                  <p className="text-stone-700 mb-4">Ou nos siga nas redes sociais:</p>
