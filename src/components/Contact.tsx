              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/5585981903334" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 font-medium">
                      (85) 98190-3334
                    </a>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-center">
                  ...
                  <div className="flex justify-center space-x-4">
                    <a href="https://www.instagram.com/drharleycavalcante/" target="_blank" rel="noopener noreferrer" className="bg-pink-500 text-white p-3 rounded-lg hover:bg-pink-600 transition-colors">
                      📷 Instagram
                    </a>
                    <a href="https://www.facebook.com/drharleycavalcante/?locale=pt_BR" target="_blank" rel="noopener noreferrer" className="bg-blue-500 text-white p-3 rounded-lg hover:bg-blue-600 transition-colors">
                      👥 Facebook
                    </a>
                  </div>
                </div>
